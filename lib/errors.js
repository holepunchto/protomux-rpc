module.exports = class RPCError extends Error {
  ...
  static BAD_REQUEST (msg, options = {}) {
    return new RPCError(msg, 'BAD_REQUEST', RPCError.BAD_REQUEST, options)
  }

  static UNAUTHORIZED (msg, options = {}) {
    return new RPCError(msg, 'UNAUTHORIZED', RPCError.UNAUTHORIZED, options)
  }

  static FORBIDDEN (msg, options = {}) {
    return new RPCError(msg, 'FORBIDDEN', RPCError.FORBIDDEN, options)
  }

  static NOT_FOUND (msg, options = {}) {
    return new RPCError(msg, 'NOT_FOUND', RPCError.NOT_FOUND, options)
  }

  static CONFLICT (msg, options = {}) {
    return new RPCError(msg, 'CONFLICT', RPCError.CONFLICT, options)
  }

  static TOO_MANY_REQUESTS (msg, options = {}) {
    return new RPCError(msg, 'TOO_MANY_REQUESTS', RPCError.TOO_MANY_REQUESTS, options)
  }
}
